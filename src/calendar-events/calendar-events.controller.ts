...
export class CalendarEventsController {
  ...
  @ApiResponse({ status: 201, description: 'The event has been successfully created.', type: CalendarEvent })
  @Post()
  create(@Body() createCalendarEventDto: CreateCalendarEventDto, @CurrentUser() user: ConnectedUser): Promise<CalendarEvent> {
  ...
  @ApiResponse({ status: 200, description: 'The calendar event has been successfully updated.', type: CalendarEvent })
  @ApiResponse({ status: 404, description: 'Calendar event not found.' })
  @Patch(':id')
  ...
  @ApiResponse({ status: 200, description: 'The calendar event has been successfully deleted.', type: ResponseStatus })
  @Delete(':id')
